...
const Letter = () => {
  const textBlocksInitial = [
    ...
    "গতকাল রাতে তোমার কথা শুনে ভীষণ কষ্ট পেয়েছি। সত্যি বলতে যদিও আমি ছেলেটা এই কথাগুলো শোনারই যোগ্য। তবুও মন খারাপ হয়। মানুষ তো আমি, আশা। তবুও সবকিছু এক পাশে রেখে সকালে টিউশনি পড়িয়ে, অফিসে এসেছি।",       
 ...
 "গতকাল বললে- তোমার কাছে যাওয়ার জন্য আমি পা তুলে নেই! তোমাকে আমার ভীষণ প্রয়োজন ছিল এই মূহুর্তে।",
